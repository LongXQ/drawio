 ...
 * 
 * (code)
 * mxLottieText.prototype.verticalTextRotation = 90;
 * (end)
 * 
 * Constructor: mxLottieText
 *
 ...
 */
function mxLottieText(value, bounds, align, valign, color,
 ...
 * Extends mxShape.
 */
mxUtils.extend(mxLottieText, mxShape);
 ...
 */
mxLottieText.prototype.baseSpacingTop = 0;
 ...
 */
mxLottieText.prototype.baseSpacingBottom = 0;
 ...
 */
mxLottieText.prototype.baseSpacingLeft = 0;
 ...
 */
mxLottieText.prototype.baseSpacingRight = 0;
 ...
 * Default is true.
 */
mxLottieText.prototype.replaceLinefeeds = true;
 ...
 */
mxLottieText.prototype.ignoreClippedStringSize = true;
 ...
 */
mxLottieText.prototype.ignoreStringSize = false;
 ...
 */
mxLottieText.prototype.textWidthPadding = (document.documentMode == 8 && !mxClient.IS_EM) ? 4 : 3;
 ...
 */
mxLottieText.prototype.lastValue = null;
 ...
 */
mxLottieText.prototype.cacheEnabled = true;
 ...
 */
mxLottieText.prototype.isHtmlAllowed = function()
{
 ...
 */
mxLottieText.prototype.getSvgScreenOffset = function()
{
	return 0;
};
 ...
 */
mxLottieText.prototype.checkBounds = function()
{
 ...
 */
mxLottieText.prototype.configurePointerEvents = function(c)
{
	// do nothing
};
 ...
 */
mxLottieText.prototype.getActualTextDirection = function()
{
 ...
 */
mxLottieText.prototype.paint = function(c, update)
{
 ...
 */
mxLottieText.prototype.redraw = function()
{
 ...
 * Resets all styles.
 */
mxLottieText.prototype.resetStyles = function()
{
 ...
 */
mxLottieText.prototype.apply = function(state)
{
 ...
 */
mxLottieText.prototype.getAutoDirection = function()
{
 ...
 */
mxLottieText.prototype.getContentNode = function()
{
 ...
 */
mxLottieText.prototype.updateBoundingBox = function()
{
	var node = this.node;
 ...
 */
mxLottieText.prototype.getShapeRotation = function()
{
	return 0;
};
 ...
 */
mxLottieText.prototype.getTextRotation = function()
{
 ...
 */
mxLottieText.prototype.isPaintBoundsInverted = function()
{
 ...
 */
mxLottieText.prototype.configureCanvas = function(c, x, y, w, h)
{
 ...
 */
mxLottieText.prototype.isShadowEnabled = function()
{
 ...
 */
mxLottieText.prototype.getHtmlValue = function()
{
	var val = this.value;
 ...
 * Private helper function to create SVG elements
 */
mxLottieText.prototype.getTextCss = function()
{
 ...
 */
mxLottieText.prototype.redrawHtmlShape = function()
{
	if (mxClient.IS_SVG)
	{
		this.redrawHtmlShapeWithCss3();	
 ...
 * Updates the HTML node(s) to reflect the latest bounds and scale.
 */
mxLottieText.prototype.redrawHtmlShapeWithCss3 = function()
{
 ...
 */
mxLottieText.prototype.fixFlexboxForIe11 = function(node)
{
 ...
 */
mxLottieText.prototype.updateHtmlTransform = function()
{
 ...
 */
mxLottieText.prototype.updateInnerHtml = function(elt)
{
 ...
 */
mxLottieText.prototype.updateHtmlFilter = function()
{
	var style = this.node.style;
	var dx = this.margin.x;
	var dy = this.margin.y;
 ...
 * Updates the HTML node(s) to reflect the latest bounds and scale.
 */
mxLottieText.prototype.updateValue = function()
{
	if (mxUtils.isNode(this.value))
	{
		this.node.innerText = '';
 ...
 * Updates the HTML node(s) to reflect the latest bounds and scale.
 */
mxLottieText.prototype.updateFont = function(node)
{
 ...
 * Updates the HTML node(s) to reflect the latest bounds and scale.
 */
mxLottieText.prototype.updateSize = function(node, enableWrap)
{
	var w = Math.max(0, Math.round(this.bounds.width / this.scale));
	var h = Math.max(0, Math.round(this.bounds.height / this.scale));
	var style = node.style;
 ...
 */
mxLottieText.prototype.updateMargin = function()
{
 ...
 * Returns the spacing as an <mxPoint>.
 */
mxLottieText.prototype.getSpacing = function(noBase, margin)
{
	var dx = 0;
	var dy = 0;
