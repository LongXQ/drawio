 ...
 */
function mxLottieText(bounds, fill, stroke, strokewidth)
{
	console.log("mxLottieText");
 ...
 * Extends mxShape.
 */
mxUtils.extend(mxLottieText, mxRectangleShape);
 ...
 */
mxLottieText.prototype.imageSize = mxConstants.DEFAULT_IMAGESIZE;
 ...
 */
mxLottieText.prototype.spacing = 2;
 ...
 */
mxLottieText.prototype.indicatorSize = 10;
 ...
 */
mxLottieText.prototype.indicatorSpacing = 2;
 ...
 */
mxLottieText.prototype.init = function(container)
{
 ...
 */
mxLottieText.prototype.paintForeground = function(c, x, y, w, h)
{
 ...
 * Generic background painting implementation.
 */
mxLottieText.prototype.paintImage = function(c, x, y, w, h)
{
	if (this.image != null)
	{
 ...
 * Generic background painting implementation.
 */
mxLottieText.prototype.getImageBounds = function(x, y, w, h)
{
 ...
 * Generic background painting implementation.
 */
mxLottieText.prototype.paintIndicator = function(c, x, y, w, h)
{
	if (this.indicator != null)
	{
 ...
 * Generic background painting implementation.
 */
mxLottieText.prototype.getIndicatorBounds = function(x, y, w, h)
{
	var align = mxUtils.getValue(this.style, mxConstants.STYLE_IMAGE_ALIGN, mxConstants.ALIGN_LEFT);
	var valign = mxUtils.getValue(this.style, mxConstants.STYLE_IMAGE_VERTICAL_ALIGN, mxConstants.ALIGN_MIDDLE);
